...
-- it inline (`exists (select 1 from profiles p where p.id =
...
-- was caught from -- the same inline pattern was repeated across 6
-- other policies on other tables too, all fixed the same way below.
